...
public class ProductController {
	...
	//ajax를 이용한
	@PostMapping(value="productWriteAction",produces={MediaType.APPLICATION_JSON_UTF8_VALUE})
	public ResponseEntity<ArrayList<ProductDTO>> productWriteAction(MultipartFile[] uploadFile) {
		System.out.println("productWriteAction실행");
		//
		...
		productdto.setPuuid(uuid.toString());
		//실제 업로드 경로를 모델에 저장
		productdto.setPuploadpath(uploadFolderPath);
